...
abstract class AbstractCard extends ClassInvocationProcessor {
     ...
     * @var string
     */
    private ? int $last_4_digits_card;
     ...
     */
    public function __construct(?string $id, ?string $card_type, ?int $last_4_digits_card) {
        $this->setId($id);
     ...
     *
     * The implementation of this method should ensure that the last four digits follow the expected format for the specific credit card type.
     *
